...
#define SERIAL_RX USART_RX_vect 
#define SERIAL_UDRE USART_UDRE_vect
// Define laser pulse output pins. NOTE: All laser pins must be on the same port. #define LASER_DDR DDRD
#define LASER_PORT PORTD
#define LASER1_BIT 4 // Uno Digital Pin 4 Driver Z-STEP
#define LASER2_BIT 7 // Uno Digital Pin 7 Driver Z-DIR
#define LASER3_BIT 4 // Uno Digital Pin 4
...
#define X_STEP_BIT 2 // Uno Digital Pin 2
#define STEP_MASK (1<<X_STEP_BIT) // All step bits
// Define step direction output pins. NOTE: All same port.
#define DIRECTION_DDR DDRD
#define DIRECTION_PORT PORTD
#define X_DIRECTION_BIT 5 // Uno Digital Pin 5 #define DIRECTION_MASK (1<<X_DIRECTION_BIT) // All direction pins must be on the direction bits (all axis)
// Define stepper driver enable/disable output pin #define STEPPERS_DISABLE_DDR DDRB
#define STEPPERS_DISABLE_PORT PORTB
#define STEPPERS_DISABLE_BIT 0 // Uno Digital Pin 8 #define STEPPERS_DISABLE_MASK (1<<STEPPERS_DISABLE_BIT)
// Define probe switch input pin. #define PROBE_DDR DDRC
#define PROBE_PIN PINC
#define PROBE_PORT PORTC
#define PROBE_BIT 5 // Uno Analog Pin 5 #define PROBE_MASK (1<<PROBE_BIT)
#endif
